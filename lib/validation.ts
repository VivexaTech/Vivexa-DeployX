...
export const projectCreateSchema = z.object({
  ...
  websiteKind: z.enum(["static", "dynamic"]).optional().default("static"),
...
export const adminPlanSchema = z.object({
  ...
  billingCycle: z.enum(["monthly", "yearly"]).optional().default("yearly"),
  razorpayPlanId: z.string().max(80).optional().default(""),
  ...
  features: z
    .object({
      freeSubdomain: z.boolean().optional().default(true),
      customDomain: z.boolean().optional().default(false),
      staticWebsite: z.boolean().optional().default(true),
      dynamicWebsite: z.boolean().optional().default(false),
